...
public class BidDAO {
	...
	public Bid getMaxWholeBidByAuctionId(int id_auction) throws SQLException {
		Bid bid = null;
		
		String performedAction = " finding max offer of an auction";
		String query = "SELECT * FROM auction_house.bid AS b WHERE b.id_auction = ? AND b.price=(SELECT MAX(c.price) FROM auction_house.bid AS c WHERE c.id_auction = ?)";
