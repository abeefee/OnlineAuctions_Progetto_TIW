...
public class AuctionDAO {
	...
	public List<Auction> getOpenedAuctionsByUserId(int id_user) throws SQLException{
		...
		String query = "SELECT * FROM auction_house.auction WHERE id_user = ? AND auction_state = 'opened' ORDER BY closing_date ASC";
	...
	public void closeAuction(int id_auction) throws SQLException{
		...
		String queryItem = "UPDATE auction_house.item SET id_auction = NULL, item_state = ? WHERE id_auction = ?";
