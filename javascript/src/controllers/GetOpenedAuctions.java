...
/**
 * Servlet implementation class GetOpenedAuctions
 */
@WebServlet("/GetOpenedAuctions")
public class GetOpenedAuctions extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String auctions = new Gson().toJson(new PacketAuctions(openedAuctions, "opened"));
